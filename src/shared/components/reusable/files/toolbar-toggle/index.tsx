...
export const ToolbarToggle: FC<ToolbarToggleProps> = ({ uploadContent, createFolderContent }) => {
    const [visible, setVisible] = useState<null | "upload" | "folder">(null);
            ...
            <AnimatePresence>
                {visible && (
                    ...
                    >
                        ...
                        >
                            {visible === "upload" ? uploadContent : createFolderContent}
                        </motion.div>
                    </motion.div>
                )}
            </AnimatePresence>
